...
Acceptance criteria
I am a customer, I hope I can join the prime membership.
- If I don’t have an account, I should create.
- If I have joined the prime, I can’t join it again.
- If I have an account without prime, I can join the prime and pay the fee.

Acceptance test
- Initialisation: I am a customer and I’m interested in the loyalty program .
...
Acceptance criteria
I am a store manager, I hope I can set the opening hours.
- I set specific business dates and time periods.
...
Acceptance criteria
I am a customer, and I hope I can register an account.
- I don't have an account, I need to register an account.

Acceptance test
- Initialisation: I am a customer and I want to have my own account.
...
Acceptance criteria
I am a customer, I hope I can order with discount.
- If I have joined the prime, I can get a 10% discount with over 30 cookies.
- If I have an account without prime, I don’t have a discount.
...
Acceptance criteria
- Each month I add a new recipe to the list
...
Acceptance criteria
- According to the store situation, I change the store tax

Acceptance test
- Initialization: I am a store manager.
...
Acceptance criteria
- If a recipe is not ordered by many people, I delete it from the list
...
Acceptance criteria
- I am a customer. I want to buy the best cookies at a discount.

Acceptance test
- Initialization: I am a customer and I want to buy the best cookies.
...
Acceptance criteria
- According to the store situation and the client situation, I decided to use MarcelEat to send the order to my home.

Acceptance test
- Initialization: I want to use MarcelEat to deliver my orders due to situations of both sides.
...
Acceptance criteria
- According to the list I choose another store for my cookies
...
Acceptance criteria
- I am a client. I hope I can view the most popular “on demand” recipe over the last 30 days.

Acceptance test
- Initialisation: I am a client and I want to see the most popular recipe.
...
Acceptance criteria
I am a customer, and I hope I can order the personalized recipe.
- I can select from the range of ingredients to create my new personalized recipes

Acceptance test
- Initialisation: I want to personalize a recipe.
...
Acceptance criteria
As a client ,I want to change the way of picking up, from picking up at the store to home delivery.
The store will contact MarcelEat and charge a standard delivery fee with an extra 50%.
...
Acceptance criteria
- I am a store manager and I received an order from a customer, and I want to verify whether it can be made.

Acceptance test
- Initialization: I received an order and I want verification
...
Acceptance criteria
- I am a store manager and I received an order from a customer, since private orders take more time and hype, I need to increase my profits by 25%.

Acceptance test
- Initialization: I received an personnel order.
...
Acceptance test
- Initialization:I am a customer, the store I’ve chosen is so busy that I should wait for a period of time.
